...
export class UserService {
  ...
  {
    return this.http.post<quoteStatus>('/api/index/quote', {
      value
    })
  }
  ...
  {
    return this.http.get<isLoggedIn>('/api/index/isLoggedIn');
  }

  logout()
  {
    return this.http.get<logoutStatus>('/api/index/logout');
  }
