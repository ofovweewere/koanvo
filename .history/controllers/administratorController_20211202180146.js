...
function DisplayRegisterAuditorPage(req, res, next) {
    if (!req.user) {
        return res.render('administratorViews/auditorIndex', { title: 'Auditor registration', page: 'registerAuditor', messages: req.flash('registerMessage'), displayName: (0, Util_1.AuditorDisplayName)(req) });
    }
