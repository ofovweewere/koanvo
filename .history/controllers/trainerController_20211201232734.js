...
passport.use(trainerModel.default.createStrategy());
//passport.use(User.createStrategy());
//passport.use(seekerModel.default.createStrategy());
passport.serializeUser(User.serializeUser() && trainerModel.default.serializeUser());
passport.deserializeUser(User.deserializeUser() && trainerModel.default.deserializeUser() );
