    ...
    tennisTrainerSeeker.default.find({
        ...
        if (err) {
            ...
            tennisTrainerSeeker.default.updateOne({ _id: id }, updatedTrainerSeeker, {}, (err) => {
                ...
                respond: res.render('administratorViews/administratorIndex', { title: 'Seeker Search Result', page: 'seekerSearchResult', trainer: updatedTrainerSeeker, displayName: (0, Util_1.AdministratorDisplayName)(req), userSearch: username, userType: req.body.userType })
            });
        }
    });
}
