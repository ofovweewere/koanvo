    ...
    tennisTrainer.default.find({
        ...
        if (err) {
            ...
            docs.forEach(function fn(doc) {
                ...
                id = `${doc._id}`;
                blocked = "true";
                blockedNotes = "Admin username: "+ admin + "\n"+ "Admin comment: "+ trainerComment;
            ...
            tennisTrainer.default.updateOne({ _id: id }, updatedTrainer, {}, (err) => {
                ...
                respond: res.render('administratorViews/administratorIndex', { title: 'Trainer Search Result', page: 'trainerSearchResult', trainer: tennisTrainer, displayName: (0, Util_1.AdministratorDisplayName)(req), userSearch: username, userType: req.body.userType })
            });
        }
    });
}
