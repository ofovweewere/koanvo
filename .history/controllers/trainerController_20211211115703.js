...
function DisplayUpdatePersonalInformation(req, res, next) {
    res.render('trainerViews/trainerIndex', { title: 'Trainer Page', page: 'updatePersonalInformation',  username: trainerName, displayName: (0, trainer_1.TrainerDisplayName)(req), user: req.user })
