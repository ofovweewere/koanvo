...
function DisplayUnblockSeeker(req, res, next) {
    return res.render('administratorViews/administratorIndex', { title: 'Unblock seeker',trainer: req.params.user ,  page: 'unblockSeeker', messages: req.flash('registerMessage'), displayName: (0, Util_1.AdministratorDisplayName)(req) });
}
