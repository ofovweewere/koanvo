        ...
        if ( userType === "Trainer") {
            tennisTrainer.default.find({
                ...
                if (err) {
                    ...
                    deferred.resolve({
                        trainer: trainer,
                        respond: res.render('administratorViews/administratorIndex', { title: 'Search Result', page: 'searchResult', trainer: trainer, displayName: (0, Util_1.AdministratorDisplayName)(req), userSearch: req.body.username, userType: req.body.userType })
                    });
                }
            });
        }
