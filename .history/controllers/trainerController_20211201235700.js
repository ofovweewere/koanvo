...
const passportTrainer = require('passport'); 
...
router.use(passportTrainer.initialize());
router.use(passportTrainer.session());
...
passportTrainer.use(tennisTrainer_1.default.createStrategy());
...
function ProcessRegisterTrainerPage(req, res, next) 
{
    ...
    tennisTrainer_1.default.register(newUser2, req.body.password, (err) => {
        ...
        return passportTrainer.authenticate('local')(req, res, () => {
