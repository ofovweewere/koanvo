    ...
    tennisTrainer_1.default.find({
        ...
        if (err) {
            ...
            deferred.resolve({
                ...
                province: province,
                city: city,
                respond: res.render('index', { title: 'Trainer Page', page: 'trainerHome', city: city, province: province, age: age, sex: sex, hourlyRate: hourlyRate, aboutMe: aboutMe, emailAddress: emailAddress, displayNameFromQuery: displayName, phoneNumber: phoneNumber, username: trainerName, displayName: (0, trainer_1.UserDisplayName)(req) })
            });
        }
    });
}
