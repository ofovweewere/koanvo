    ...
    tennisTrainer_1.default.find({
        ...
        if (err) {
            ...
            deferred.resolve({
                ...
                city: city,
                approved: approved,
                respond: res.render('trainerViews/trainerIndex', { title: 'Trainer Page', page: 'updatePersonalInformation', approved: approved, city: city, province: province, age: age, sex: sex, hourlyRate: hourlyRate, aboutMe, emailAddress: emailAddress, displayNameFromQuery: displayName, phoneNumber: phoneNumber, username: trainerName, displayName: (0, trainer_1.TrainerDisplayName)(req), user: req.user })
            });
        }
    });
}
