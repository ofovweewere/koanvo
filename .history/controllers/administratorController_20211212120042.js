...
function DisplayBlockTrainer(req, res, next) {
    return res.render('administratorViews/administratorIndex', { title: 'Block trainer',trainer: req.params.trainer ,  page: 'blockTrainer', messages: req.flash('registerMessage'), displayName: (0, Util_1.AdministratorDisplayName)(req) });
}
