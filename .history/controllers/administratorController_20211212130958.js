    ...
    tennisTrainer_1.default.find({
        ...
        if (err) {
            ...
            tennisTrainer_1.default.updateOne({ _id: id }, updatedTrainer, {}, (err) => {
                ...
                respond: res.render('administratorViews/administratorIndex', { title: 'Trainer Search Result', page: 'trainerSearchResult', trainer: trainer, displayName: (0, Util_1.AdministratorDisplayName)(req), userSearch: username, userType: req.body.userType })
            });
        }
    });
}
